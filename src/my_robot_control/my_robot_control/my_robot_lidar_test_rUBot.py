...
class LidarTest(Node):
    ...
    def listener_callback(self, scan):
        ...
        angle_offset = 180 # Sensor looking backwards
        angle_min_deg = scan.angle_min * 180.0 / 3.14159 - angle_offset
        angle_max_deg = scan.angle_max * 180.0 / 3.14159 - angle_offset
        ...
        if custom_range:
            ...
            angle_closest_distance = self.normalize_angle(angle_min_deg + element_index * angle_increment_deg)
